...
window.addEventListener("load", function () {
  if (!title && !description && !username && !picture) {
    Swal.fire(
      "Warning!",
      "Stream title and description is required!",
      "error"
    ).then(() => {
          ...
          <div class="liveDetails">
            ...
            <img src="${
              ...
              "https://res.cloudinary.com/ddbtxfsfk/image/upload/v1677178789/user-image-with-black-background_oslni5.png"
                ...
                : picture
            }" style="border-radius: 50%; border: 2px solid #ba00ba;" width="50px" onclick="window.location='user.html?username=${username}'" alt="${username} Profile picture" />
              <div class="liveText">
                <p>
